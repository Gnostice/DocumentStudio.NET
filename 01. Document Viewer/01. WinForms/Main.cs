...
namespace WinForms_CS_Document_Viewer
{
    public partial class Main : Form
    {
        ...
        public Main()
        {
            ...
            DocumentViewer1.PagesAdded += DocumentViewer1_PagesAdded;
            DocumentViewer1.DocumentProcessingError += DocumentViewer1_DocumentProcessingError;
            DocumentViewer1.AllowInteractivity = true;
            
        }

        private void DocumentViewer1_DocumentProcessingError(object sender, DocumentProcessingErrorEventArgs e)
        {
            MessageBox.Show(e.Exception.ToString(), "Document Processing Error");
        }
        
        private void DocumentViewer1_PagesAdded(object sender, PagesAddedEventArgs e)
        {
        ...
        {
            if (DocumentViewer1.NavigationPane.VisibilityState ==VisibilityState.Expanded)
            {
                navigationPaneToolStripMenuItem.Image = null;
                DocumentViewer1.NavigationPane.VisibilityState = VisibilityState.Collapsed;
            }
            else
            {
                navigationPaneToolStripMenuItem.Image = WinForms_CS_Document_Viewer.Properties.Resources.tick;
                DocumentViewer1.NavigationPane.VisibilityState = VisibilityState.Expanded;
            }
        }
