...
namespace ConvertToIMG
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Output Format
            string outputFormat = "png"; // or bmp
            ...
            // Converting sample input file to PNG format
            ...
            docConverter.ConvertToFile(inputFiles, outputFormat, outputPath, "ConvertToPNG_OneToOne_Multiple", ConversionMode.ConvertToSeperateFiles);
            ...
            docConverter.ConvertToFile(inputFiles, outputFormat, outputPath, "ConvertToPNG_ManyToOne", ConversionMode.ConvertToSingleFile);
            ...
            docConverter.ConvertToFile(inputFile, outputFormat, outputPath, "ConvertToPNG_WithConverterSettings_Even", ConversionMode.ConvertToSeperateFiles, null, cp);
            ...
            docConverter.ConvertToFile(inputFile, outputFormat, outputPath, "ConvertToPNG_WithConverterSettings_Custom", ConversionMode.ConvertToSeperateFiles, null, cp);

            #endregion

            #region PNG encoder formats

            PNGEncoderSettings pngEncoderFormats = new PNGEncoderSettings();

            // Page Scaling
            // 2 Page Scaling settings
            // PageScaling.None => No page scaling done
            // PageScaling.UseRengeringResolution => perform scaling using rendering resolution
            pngEncoderFormats.PageScalling = PageScalling.UseRenderingResolution;
            ...
            pngEncoderFormats.RenderingSettings.Image.CompositingMode = System.Drawing.Drawing2D.CompositingMode.SourceCopy;
            ...
            pngEncoderFormats.RenderingSettings.Image.CompositingQuality = System.Drawing.Drawing2D.CompositingQuality.Default;
            ...
            pngEncoderFormats.RenderingSettings.Image.InterpolationMode = System.Drawing.Drawing2D.InterpolationMode.Default;
            ...
            pngEncoderFormats.RenderingSettings.Image.PixelOffsetMode = System.Drawing.Drawing2D.PixelOffsetMode.Default;
            ...
            pngEncoderFormats.RenderingSettings.LineArt.SmoothingMode = System.Drawing.Drawing2D.SmoothingMode.Default;

            //Text Contarst
            pngEncoderFormats.RenderingSettings.Text.TextContrast = 5;
            ...
            pngEncoderFormats.RenderingSettings.Text.TextRenderingHint = System.Drawing.Text.TextRenderingHint.SystemDefault;

            // Rendering Settings resolution
            pngEncoderFormats.RenderingSettings.Resolution.DPI = 96f;
            pngEncoderFormats.RenderingSettings.Resolution.DpiX = 96f;
            pngEncoderFormats.RenderingSettings.Resolution.DpiY = 96f;
            ...
            pngEncoderFormats.RenderingSettings.Resolution.ResolutionMode = ResolutionMode.UseSource;

            // Resolution Settings resolution
            pngEncoderFormats.ResolutionSettings.DPI = 96f;
            pngEncoderFormats.ResolutionSettings.DpiX = 96f;
            pngEncoderFormats.ResolutionSettings.DpiY = 96f;
            ...
            // ResolutionMode.UseDevice => use device resolution
            // ResolutionMode.UseSpecifiedDPI => use DPI specified in  pngEncoderFormats.RenderingSettings.Resolution.DPI            
            pngEncoderFormats.ResolutionSettings.ResolutionMode = ResolutionMode.UseSource;

            docConverter.ConvertToFile(inputFile, outputFormat, outputPath, "ConvertToPNG_WithEncoderSettings", ConversionMode.ConvertToSeperateFiles, pngEncoderFormats);
